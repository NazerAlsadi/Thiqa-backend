...
@section('content')
 ...
 <div class="col-md-12">
 	<div>
 		<a href="chang-to-admin" class="btn btn-success">إضافة مدير</a>
 	</div>
    <div class="card">
	    <div class="card-header card-header-primary ">
	      <h4 class="card-title">قائمة المدراء</h4>
	      <p class="card-category">مستخدمين يملكون صلاحية الدخول الى لوحة التحكم</p>
        ...
        <div class="card-body table-responsive">
            <table class="table table-hover">
		        ...
		        <tr>
		            ...
		            <td><a href="{{ URL::to('changeUserPass/' . $user->id) }}">
         
                        تعديل كلمة السر</a>	</td>
