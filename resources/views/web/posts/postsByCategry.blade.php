...
{{------------------------------------------------- posts --------------------------------------------------}}
    ...
    @if ($posts)
    <div style="text-align: right">  <a href="{{url('MainCategories')}}"><b class="blufont">الفئات الرئيسية / </b></a> <a href="{{url('subcategories/'.$main_category->id)}}"><b class="blufont"> {{$main_category->category_name}} / </b></a><b class="blufont">{{$category_name->category_name}}</b></div><hr>
